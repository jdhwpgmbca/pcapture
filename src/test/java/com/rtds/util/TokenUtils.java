...
public class TokenUtils
{
     ...
     */
    public static String generateTokenString( String jsonResName, Map<String, Long> timeClaims ) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException
    {
